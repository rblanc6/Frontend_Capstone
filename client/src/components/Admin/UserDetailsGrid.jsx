...
export default function UserDetailsGrid({ isGridView }) {
  ...
  const LongText = ({ content,limit}) => {
    ...
    if (showAll) {
      ...
      return <div> 
        {content} 
        <span onClick={showLess} style={{color: "#de296c", marginLeft: "4px"}}><small>Read less</small></span> 
      </div>
    }
    ...
    return <div> 
      {toShow} 
      <span onClick={showMore} style={{color: "#de296c", marginLeft: "4px"}}><small>Read more</small></span>
    </div>
  }
  ...
  return (
    <>
      ...
      <h1 className="display-6 mt-5" id="recipes">User&apos;s Recipes</h1>
      <div>
                  ...
                  >
                    ...
                    <Link
                        ...
                        style={{
                          position: "absolute",
                          bottom: "0",
                          margin: "20px 0",textDecoration: "none"
                        }}
                      >
                        View Recipe
                      </Link>
        ...
        <h1 className="display-6 mt-5" id="reviews">User&apos;s Reviews</h1>
        ...
        <h1 className="display-6 mt-5" id="comments">User&apos;s Comments</h1>
        <div className="row g-2">
          {Array.isArray(paginatedComments) && paginatedComments.length > 0
            ? paginatedComments.map((comment, index) => (
                <div className="col-md-4" key={index}>
                  ...
                  >
                    ...
                    <div className="card-body" style={{ marginBottom: "20px" }}>
                      <h5 className="card-title"><LongText content = {comment.comment} limit = {100} /> </h5>
                      <p className="date-stamp">
